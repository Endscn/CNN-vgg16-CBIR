...
#python main.py --data_path D:/Jupyter/gitCBIR/flask-keras-cnn-image-retrieval-master/label_img/train_data/ --test_data_path_to_save D:/Jupyter/gitCBIR/flask-keras-cnn-image-retrieval-master/label_img/validation_data/ --train_ratio 0.7
#arg 이용해서 터미널에서 train_data와 validation data를 나눈다. main.py로 설정하고 사용해야한다.
