...
start = time.time()
Test_model = keras.models.load_model('D:/Jupyter/gitCBIR/flask-keras-cnn-image-retrieval-master/testmodels/210523_real_model_bat16_epoch5_mixed7_Adam5e-05_true_1.h5')
end = time.time()
...
My_images = get_final_test("https://cdn.pixabay.com/photo/2014/10/31/17/41/dancing-dave-minion-510835_960_720.jpg") #예시 이미지 (주소로 바로 넣어주면 테스트 가능)
