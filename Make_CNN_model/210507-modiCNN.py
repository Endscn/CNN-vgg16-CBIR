...
def get_final_test(img_path):
    ...
    images = np.array(
        Image.open(requests.get(img_path, stream=True).raw).convert('RGB').resize((300, 300), Image.ANTIALIAS))
...
model_name = "test_model" + "_bat" + str(batch_size) + "_epoch" + str(epochs) + "_mixed7"+"_Adam"+str(learning_rate) + "_true"
